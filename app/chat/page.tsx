...
export default function Home() {
  ...
  return (
    <div className="max-w-[1000px] w-2/3 mx-auto p-4 h-[calc(100vh-60px)] flex flex-col">
      ...
      <div className="flex-1 border rounded-md p-4 mb-4 overflow-auto scrollbar-thin" ref={viewportRef}>
